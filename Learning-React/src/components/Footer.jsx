...
function Footer() {
  return (
    <div data-scroll data-scroll-speed = ".7" className="h-screen w-full flex px-14 py-4">
      <div className="h-full w-[50%] flex flex-col items-start justify-between">
        <div>
          <h1 className='text-[7vw] tracking-tighter -mb-20 font-[600] font-["Founders_Grotesk_Condensed"]'>
            EYE-
          </h1>
          <h1 className='text-[7vw] tracking-tighter -mb-20 font-[600] font-["Founders_Grotesk_Condensed"]'>
            OPENING
      ...
      <div className="h-full w-[50%] flex flex-col items-start gap-40 ">
        <div>
          <h1 className='text-[6vw] tracking-tighter -mb-20 font-[600] font-["Founders_Grotesk_Condensed"]'>
            PRESENTATIONS
          </h1>
        </div>
        <div className="w-full">
          {["Instagram", "Behance", "Facebook", "Linkedin"].map((e, index) => (
            <div>
              <a className="underline" key={index}>
                {e}
              </a>
            </div>
          ))}
          <div className="w-full  mt-20  ml-[38vw] flex-col flex justify-between">
